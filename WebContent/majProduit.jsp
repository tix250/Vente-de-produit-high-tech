									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<div class="try_sh_main_box_wrapper">
											...
											<div class="try_sh_img_cont_wrapper">
												...
												<div class="try_sh_btn_wrapper">	<a href="crud?update=<c:out value="${ ecouteurs.getId_produit() }" />">Mettre a jour</a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<div class="try_sh_main_box_wrapper">
											...
											<div class="try_sh_img_cont_wrapper">
												...
												<div class="try_sh_btn_wrapper">	<a href="crud?update=<c:out value="${ phone.getId_produit() }" />">Mettre a jour</a>
												</div>
											</div>
										</div>
									</div>
