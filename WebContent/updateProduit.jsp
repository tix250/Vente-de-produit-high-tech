    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a style="display: none;" class="nav-link" href="liste_achat.php">Mettre a jour un produit</a>
          </li>
    ...
    <div class="container" >
      <div class="row">
        <div id="block1" class="col-md-12">
          ...
          <h2 class="h2">Mettre a jour un produitt</h2>
        ...
        <div id="block2" class="col-md-6" style="border:1px solid black; display:none;">
          <h2>Suprimer des produits</h2>
            <form action="supr_categorie.php" method="post">
              ...
              <p><input type="submit" name="envoyer"  value="update">></p>
            </form>
        </div>
        <div id="block2" class="col-md-6" style="border:1px solid black; display:none;">
          ...
          <form action="udpate_produit.php" method="post">
              ...
              <p><input type="submit" name="envoyer" value="upload"> </p>
            </form>
        </div>
      </div>
    </div>
