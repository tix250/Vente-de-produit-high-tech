				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="try_sh_main_section_wrapper">
							<div class="row">
								<c:forEach items="${ listePaniers }" var="listePanier" varStatus="status">
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<div class="try_sh_main_box_wrapper">
											<div class="try_sh_img_wrapper">
												<img height="160" src="<c:out value="${ listePanier.getImage_produit() }" />"> 
											</div>
											<div class="try_sh_img_cont_wrapper">
												<h3><c:out value="${ listePanier.getNom_produit() }" /> </h3>
												<p><c:out value="${ listePanier.getPrix_produit() }" /> Ariary </p>
												<div class="try_sh_btn_wrapper">	<a href="panier?supr=<c:out value="${ listePanier.getId_produit() }" />">Suprimer</a>
												</div>
											</div>
										</div>
									</div>
					...
					<h2>Total a payer :  ${ prixTotal } Ariary TTC</h2> 
					<div class="try_sh_btn_wrapper">	<a href="payment?valider=ok"> Valider mon achat</a>
					</div>
				</div>
			</div>
		</div>
